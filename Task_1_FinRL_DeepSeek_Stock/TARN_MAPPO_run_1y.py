...
sweep_config = {
    ...
    "parameters": { 
        ...
        "gamma": {"values": [0.999, 0.995 ,0.99]},
        # "gamma": {"values": [0.99]},

        "eps_clip": {"values": [0.1, 0.2, 0.3]},
        "reward_cond" : {"values": [ "sharpe", "combined"]},
...
if __name__ == "__main__":
    ...
    SEED = 42
    set_seed(SEED)
    sweep_id = wandb.sweep(sweep_config, project="TARN-MAPPO-project_daily_year_gammas")
