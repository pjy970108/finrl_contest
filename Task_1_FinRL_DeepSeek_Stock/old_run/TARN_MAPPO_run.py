...
if __name__ == "__main__":
    ...
    SEED = 42
    set_seed(SEED)
    sweep_id = wandb.sweep(sweep_config, project="TARN-MAPPO-project_daily_high_risk_test")
